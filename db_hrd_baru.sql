...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Jul 2020 pada 11.00
...
(5, 'Pembelian', 1600000),
(6, 'Penjualan', 1700000),
(19, 'General Affair', 2300000),
(21, 'Telekomunikasi', 1400000);
...
(8, 21, 1, 'Suparman', 'Jakarta', 48),
(10, 5, 2, 'Junaedi', 'Rawa Bogo', 34),
(11, 1, 3, 'Sumirah', 'Bogor', 23),
(13, 5, 1, 'Hendra', 'Balikpapan', 56);
...
(12, 1, 3, 'Iskandar Muda', 'Jakarta Selatan', 23);
...
--
ALTER TABLE `divisi`
  MODIFY `id_divisi` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
